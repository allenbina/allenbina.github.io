...
const siteConfig: SiteConfig = {
  name: 'Allen Bina',
  description:
    'I build things. Sometimes with code, sometimes with a soldering iron, sometimes with a 3D printer.',
  url: SITE_URL || 'https://allenbina.github.io',
  ogImage: '/og-default.svg',
  author: 'Allen Bina',
  email: '',
  socialLinks: [
    'https://github.com/allenbina',
    'https://www.linkedin.com/in/allenbina/',
    'https://www.instagram.com/zibabina/',
  ],
